...
namespace Cifrado
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("***Bienvenido al Cifrador Cesar***\n\n");

                Console.WriteLine("Ingrese la frase que desea Cifrar y luego presione ENTER.\n");
                Console.Write("Frase: ");
            ...
            Console.WriteLine($"La base para el Cifrador es la siguiente:\n\n{Constantes.CaracteresCifrar}\n");
            ...
            Frase = Cesar.Cifrar(Frase, Clave);
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine($"Frase Cifrada: {Frase}\n\n");
            Console.ForegroundColor = ConsoleColor.White;
